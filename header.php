...
<head>
    ...
    <link rel="preload" href="<?php echo get_template_directory_uri(); ?>/assets/fonts/FreightNeo-Black.woff2" as="font" type="font/woff2" crossorigin="anonymous">
...
<body <?php $filename = basename(__FILE__, '.php'); body_class( array( wp_is_mobile() ? 'wp-is-mobile' : 'wp-is-desktop', get_field('sticky', 'option') ? 'header-sticky' : '', $filename ) ); ?>>
    <div id="page" class="site">
        ...
        <header id="header-site" class="site-header rightside-menu-header">
